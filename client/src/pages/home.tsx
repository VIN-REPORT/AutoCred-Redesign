      ...
      <section className="py-16 md:py-20 bg-neutral-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-6 lg:gap-8 place-items-center w-full">
            <div className="flex flex-col items-center justify-center gap-2 md:gap-3 w-full" data-aos="zoom-in">
              <div className="text-4xl md:text-5xl lg:text-6xl">🇺🇸</div>
              <span className="text-xs md:text-sm font-medium text-gray-300">USA</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-2 md:gap-3 w-full" data-aos="zoom-in">
              <div className="text-4xl md:text-5xl lg:text-6xl">🇨🇦</div>
              <span className="text-xs md:text-sm font-medium text-gray-300">Canada</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-2 md:gap-3 w-full" data-aos="zoom-in">
              <div className="text-4xl md:text-5xl lg:text-6xl">🇬🇧</div>
              <span className="text-xs md:text-sm font-medium text-gray-300">UK</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-2 md:gap-3 w-full" data-aos="zoom-in">
              <div className="text-4xl md:text-5xl lg:text-6xl">🇦🇺</div>
              <span className="text-xs md:text-sm font-medium text-gray-300">Australia</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-2 md:gap-3 w-full" data-aos="zoom-in">
              <div className="text-4xl md:text-5xl lg:text-6xl">🇫🇷</div>
              <span className="text-xs md:text-sm font-medium text-gray-300">France</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-2 md:gap-3 w-full" data-aos="zoom-in">
              <div className="text-4xl md:text-5xl lg:text-6xl">🇩🇪</div>
              <span className="text-xs md:text-sm font-medium text-gray-300">Germany</span>
            </div>
          </div>
        </div>
      </section>
